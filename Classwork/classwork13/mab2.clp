...
(defrule startup ""
  =>
  (assert (monkey (location green-couch) (on-top-of green-couch) (holding nothing)))
  (assert (thing (name green-couch) (location green-couch) (weight heavy)))
  (assert (thing (name red-couch) (location red-couch) (weight heavy)))
  (assert (thing (name big-pillow) (location red-couch) (on-top-of red-couch)))
  (assert (thing (name red-chest) (location red-couch) (on-top-of big-pillow)))
